...
//     this.basePath = `/hotels/${hotelName}/options`;
//   }
...
//   // Add new option
//   async addOption(category, value, adminId) {
...
//     const optionId = uid();
//     await set(ref(db, `${this.basePath}/${category}/${optionId}`), {
//       id: optionId,
//       value: value.trim(),
//     });
...
//   // Update option
//   async updateOption(category, optionId, newValue, adminId) {
//     const hasPermission = await this.checkAdminPermission(adminId);
//     if (!hasPermission) {
//       throw new Error("You do not have permission to update options for this hotel.");
//     }

//     await update(ref(db, `${this.basePath}/${category}/${optionId}`), {
//       id: optionId,
//       value: newValue.trim(),
//     });
...
//   // Delete option
//   async deleteOption(category, optionId, adminId) {
//     const hasPermission = await this.checkAdminPermission(adminId);
//     if (!hasPermission) {
//       throw new Error("You do not have permission to delete options for this hotel.");
//     }

//     await remove(ref(db, `${this.basePath}/${category}/${optionId}`));
//   }
// }
