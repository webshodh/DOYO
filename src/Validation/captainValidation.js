...
export const validateMobileNo = (
  ...
  const isDuplicate = existingCaptains.some(
    (captain) =>
      captain.mobileNo === trimmed && captain.captainId !== excludeId,
  );
...
export const validateAdharNo = (
  ...
  // Check for duplicates
  const isDuplicate = existingCaptains.some(
    (captain) => captain.adharNo === trimmed && captain.captainId !== excludeId,
  );
...
export const validateCaptainForm = (
  ...
  const mobileValidation = validateMobileNo(
    captainData.mobileNo,
    existingCaptains,
    excludeId,
  );
  ...
  const adharValidation = validateAdharNo(
    captainData.adharNo,
    existingCaptains,
    excludeId,
  );
  ...
  const panValidation = validatePanNo(
    captainData.panNo,
    existingCaptains,
    excludeId,
  );
