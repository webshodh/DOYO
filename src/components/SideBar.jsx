    ...
    <aside id="sidebar" className="sidebar">
      <ul className="sidebar-nav" id="sidebar-nav">
        ...
        <>
          ...
          <li className="nav-item">
            <Link className="nav-link" to={`/${hotelName}/super-admin/revenue`}>
              <i className="bi bi-grid"></i>
              <span>Revenue Managment</span>
            </Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link" to={`/${hotelName}/super-admin/hotels`}>
        ...
        <button onClick={handleClick}>{!admin ? 'Admin' :'Super Admin'}</button>
        <li>
