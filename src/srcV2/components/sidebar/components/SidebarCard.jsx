...
const FreeCard = () => {
  return (
    <div className="relative mt-14 flex w-[230px] justify-center rounded-[20px] pb-4" style={{background:`${colors.Orange}`}}>
      {/* <div className="absolute -top-12 flex h-24 w-24 items-center justify-center rounded-full border-[4px] border-white" style={{background:`${colors.Orange}`}}>
        <svg
          width="41"
          height="41"
          viewBox="0 0 41 41"
