        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 shadow-sm p-4">
          ...
          <div className="mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-500">
              <span>
                {timeFilteredOrders.length} {t("dashboard.orders")}
              </span>
              ...
              {displayStats.completionRate > 0 && (
                <span>
                  {displayStats.completionRate}% {t("dashboard.completionRate")}
                </span>
              )}
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
          <div className="transform hover:scale-105 transition-all duration-300">
            <StatCard
              ...
              color="indigo"
              icon={ShoppingBag}
              subtitle={`${displayStats.uniqueCustomers} ${t(
          ...
          <div className="transform hover:scale-105 transition-all duration-300">
            <StatCard
              ...
              color="green"
              subtitle={`${displayStats.completionRate}% ${t(
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div>
                ...
                <div className="text-sm text-gray-500">
                  {categoryAnalytics.totalCategoryOrders}{" "}
                  {t("dashboard.totalItemsOrdered")}
                </div>
              </div>
