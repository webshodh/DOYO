...
const payeeName = 'Vishal'
  const handleFeedbackChange = (e) => {
    ...
    if (checked) {
      ...
      setSelectedFeedback((prev) => prev.filter((feedback) => feedback !== value));
    }
  };
              ...
              {['😞', '😐', '😊', '😁', '😍'].map((emoji, index) => (
                <span 
                  ...
                  style={{ 
                    ...
                    fontSize: '2rem', 
                    margin: '0 5px', 
                    filter: rating === index + 1 ? 'drop-shadow(0 0 10px white)' : 'none'
                  }}
                >
                  {emoji}
                </span>
            ...
            {rating && (
              <Form>
                <Form.Group controlId="feedbackSelect">
                  <Form.Label>Select Feedback (You can select multiple options)</Form.Label>
